...
namespace RHSkillEditor
{
    ...
    public class SkillTree
    {
        ...
        CustomNode buildTree(SkillTreeNode stn)
        {
            //List<TreeNode> nodes = new List<TreeNode>();
            CustomNode thisTNode = new CustomNode(stn);
            thisTNode.Tag = stn;
        ...
        public CustomNode[] buildTrees()
        {
            roots.Clear();
            getRoots();
            List<CustomNode> treeNodes = new List<CustomNode>();
